This is a [VS Code development container](https://github.com/microsoft/vscode-dev-containers) for the [ponyalng](https://tutorial.ponylang.io/getting-started/hello-world.html).
